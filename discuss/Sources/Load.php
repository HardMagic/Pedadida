...
function loadMemberData($users, $is_name = false, $set = 'normal')
{
	...
	if ($set == 'normal')
	{
		$select_columns = '
			...
			mem.myspace AS myspace, mem.facebook, mem.twitter, mem.youtube, mem.deviantart, mem.googleplus, mem.linkedin, mem.pinterest, mem.birthdate, mem.member_ip, mem.member_ip2, mem.icq, mem.aim, mem.yim, mem.msn, mem.posts, mem.last_login,
	...
	elseif ($set == 'profile')
	{
		$select_columns = '
			...
			mem.signature, mem.personal_text, mem.location, mem.gender, mem.avatar, mem.id_member, mem.member_name,
			mem.real_name, mem.email_address, mem.hide_email, mem.date_registered, mem.website_title, mem.website_url,
			mem.openid_uri, mem.myspace AS myspace, mem.facebook, mem.twitter, mem.youtube, mem.deviantart, mem.googleplus, mem.linkedin, mem.pinterest, mem.birthdate, mem.icq, mem.aim, mem.yim, mem.msn, mem.posts, mem.last_login, mem.karma_good,
...
function loadMemberContext($user, $display_custom_fields = false)
{
	...
	foreach (array('icq', 'msn', 'aim', 'yim', 'facebook', 'myspace', 'twitter', 'googleplus', 'linkedin', 'youtube', 'deviantart', 'pinterest') as $messenger)
	{
