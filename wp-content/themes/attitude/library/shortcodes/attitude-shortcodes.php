...
function attitude_wp_link_shortcode() {
   return '<a href="'.esc_url( 'http://hardmagic.com' ).'" target="_blank" title="HardMagic"><span>HardMagic</a>';
}
...
function attitude_themehorse_link_shortcode() {
   return '<a href="'.esc_url( 'http://pedadida.com' ).'" target="_blank" title="Pedadida" ><span>Pedadida</span></a>';
}
