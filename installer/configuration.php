<?php if(!defined('INST_BASEDIR')) die('Direct access is not allowed!');
    ...
    *  ================================================================= */
	...
	define('STEP_CONFIGEXTRAS',	'configextras');
	define('STEP_HIDDENKEYS',	'hiddenkeys');
	...
	STEP_MODULECHECK => array(
		...
		'enabled'  =>  true,
		'autoskip' =>  true,
		'modules'  =>  array('mysqli','mcrypt','iconv','mbstring','curl','ctype','zip','gd','simplexml','spl','pcre','dom','xml','json'),
		),
	...
	|======================================================================|
	|  Prompts username, password and host input fields that the user 
	...
	|----------------------------------------------------------------------|
	|  Specific to Pedadida.  Has many variables listed here.
	\---------------------------------------------------------------------*/
	STEP_CONFIGEXTRAS => array(
		'title'        =>  'Extra Config Options',
		'enabled'      =>  true,
		'optional'     =>  true,
		'separator'    =>  '_',  
		),
	...
	\--------------------------------------------------------------------*/
	'installer_title_name' => 'Pedadida Installation',
    ...
    'special' => array(    
		...
		'charset' => 'utf8',
		'collate' => '',
		'key1' => 'L%q@+#kyQ_yrT^}%&TZPd!v(omnBKNu3hB0RF4k*&;=_&B%K9,!U;5DX]yH1txT_',
		'key2' => 'F,`OV_0__;B>wH*?D}F>l?:;@:@`VBr+Awrq8O+H|(28[yW;pQmhw:dhl}0<Uc4V',
		'key3' => 'piGE%<YJvV+d|eh?p-vT5;8VC%P3{y60-N@KpX{|kzNTraB-F++|T},dK SM&3cs',
		'key4' => 'KhPxsL?N<8_=j#nC q80uN2QW&yJ5AaK=2V+~s9}{TV+f#HN}?67Kd*!-  W@bfR',
		'key5' => '{PE c_y3/(`nU>Y|>(Fsqbv51{xRe_C1A%mc1Y)&cG*C8beJ3-LZW3WYp;i_gpmG',
		'key6' => 'j%yv{G|gm++jEAt[-A+?QKC}Uo=HZ><y!~Wc|M0;A<-G#XCfHkny0OM89|*#vfq ',
		'key7' => '[g}v8+`w`GL$C>{| vFk:gZQrw|9[vwf21:CO/o8l9&:+g}=[muwwFoc#6dmAQL-',
		'key8' => '_1qVuQp(NtcW8 PM`sy:UJ.fV:Cwvv9fy$M6sNg-u7O+JZ^TNqsVZ?Iw(Joikkh=',
		'bin_path' => '/usr/bin',
		'classroom_data' => '/home/example/classdata',
		'lab_storage' => 'example.com/lab/upload',
		'lab_name' => 'University Lab',
		'library_secure' => 'false',
		'email_notify' => 'notify@example.com',
		'imagemagick_path' => '/usr/bin',
		'ffmpeg_path' => '/usr/local/bin',
		'exiftool_path' => '/usr/bin',
		'antiword_path' => '/root/antiword',
		'ghostscript_path' => '/usr/bin',
		'php_path' => '/usr/local/bin',
		'library_name' => 'Library',
		'class_name' => 'Classroom',
		'university_name' => 'The Great University',
		'library_password' => '',
		'admin_password_hash' => '',
