...
$CFG->dbtype    = $pedidada_database_type;      // 'pgsql', 'mysqli', 'mssql', 'sqlsrv' or 'oci'
$CFG->dblibrary = 'native';     // 'native' only at the moment
$CFG->dbhost    = $pedadida_database_host;  // eg 'localhost' or 'db.isp.com' or IP
$CFG->dbname    = $pedadida_database_name;     // database name, eg moodle
$CFG->dbuser    = $pedadida_database_username;   // your database username
$CFG->dbpass    = $pedadida_database_password;   // your database password
