...
/**
 * Authentication Plugin: External Database PedaDida Authentication
 *
 ...
 */
class auth_plugin_db_pedadida extends auth_plugin_base {
    ...
    function __construct() {
        ...
        $this->authtype = 'db_pedadida';
        $this->config = get_config('auth/db_pedadida');
     ...
     */
     function validate_form($form, &$err) {
        if ($form->passtype === 'internal') {
            ...
            set_config('changepasswordurl', '', 'auth/db_pedadida');
        }
    }
    ...
    function process_config($config) {
        ...
        // Save settings.
        set_config('host',          $config->host,          'auth/db_pedadida');
        set_config('type',          $config->type,          'auth/db_pedadida');
        set_config('sybasequoting', $config->sybasequoting, 'auth/db_pedadida');
        set_config('name',          $config->name,          'auth/db_pedadida');
        set_config('user',          $config->user,          'auth/db_pedadida');
        set_config('pass',          $config->pass,          'auth/db_pedadida');
        set_config('table',         $config->table,         'auth/db_pedadida');
        set_config('fielduser',     $config->fielduser,     'auth/db_pedadida');
        set_config('fieldpass',     $config->fieldpass,     'auth/db_pedadida');
        set_config('passtype',      $config->passtype,      'auth/db_pedadida');
        set_config('extencoding',   trim($config->extencoding), 'auth/db_pedadida');
        set_config('setupsql',      trim($config->setupsql),'auth/db_pedadida');
        set_config('debugauthdb',   $config->debugauthdb,   'auth/db_pedadida');
        set_config('removeuser',    $config->removeuser,    'auth/db_pedadida');
        set_config('changepasswordurl', trim($config->changepasswordurl), 'auth/db_pedadida');
